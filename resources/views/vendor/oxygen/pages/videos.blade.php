        ...
        <div class="row justify-content-center" style="display: flex; justify-content: center;">
            ...
            <div class="col col-md-12" style="padding: 25px;">
                <div class="row" style="margin: 0px!important; margin-bottom: 30px!important">
                    <span class="articles">Videos</span>
                </div>
                <div class="tableFixHead">
                    <table class="table table-seperated ">
                        <thead style="display: table-header-group!important;">
                        {{--<tr style="background-color: transparent;">
                            <th  class="article-title" style="background-color: transparent; padding-left: 12px;"> Name</th>
                        </tr>--}}
                        </thead>
                        <tbody>
                        @foreach ($videos as $video)
                        <tr class="articles-row">
                            <td class="artical-title ellipsis" style="vertical-align: middle;">{{$video->title}}</td>
                            <td class="client-inverse" style="vertical-align: middle;">
                            <a href="{{ $video->url}}" target="_blank" class="btn-download"><em class="fa fa-video"></em> View
                            </a>
