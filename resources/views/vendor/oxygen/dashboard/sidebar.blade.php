...
{{--@if ($user->can('view-permissions'))--}}
    <ul class="nav nav-pills nav-wide flex-column">
        ...
        <li><a href="{{ route('manage.articles.index') }}"><i class="fas fa-newspaper"></i> Articles</a></li>
        <li><a href="{{ route('manage.videos.index') }}"><i class="fas fa-newspaper"></i> Videos</a></li>
        <li><a href="{{ route('manage.subscribers') }}"><i class="fas fa-credit-card"></i> Subscribers</a></li>
