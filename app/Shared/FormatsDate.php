...
trait FormatsDate
{
    ...
    private function formattedDate($dateValue)
    {
        ...
        return $this->inUsersTimezone($dateValue)
            ->format(config('oxygen.dateFormat'));
    }
    ...
    private function formattedTime($dateValue)
    {
        ...
        return $this->inUsersTimezone($dateValue)
            ->format(config('oxygen.timeFormat'));
    }
    ...
    private function toDateObject($dateValue): array
    {
        return [
            ...
            'timestamp' => $this->formattedDate($dateValue) . ' ' . $this->formattedTime($dateValue),
    ...
    {
        $timezone = optional(auth()->user())->timezone ?? config('oxygen.timezone');
